...
class DoctorScheduleManage extends Component {
    ...
    handleAddHoursExamination = (e, item) => {
     ...
     handleSaveOnChanges = async () => {
        if (this.state.selectedOption) {
           ...
           await postScheduleDoctor(this.state.scheduleExaminates)
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <h4>Manage Schedule from admin</h4>
...
export default connect(mapStateToProps, mapDispatchToProps)(DoctorScheduleManage);
