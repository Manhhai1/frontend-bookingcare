...
import { postTelemedicine } from '../../../../services/telemedicineSevice';
...
class ModalCreate extends Component {
    ...
    handleOnClickCreateNewTelemedicine = async () => {
        ...
        if (check) {
            await postTelemedicine(dataPost)
        ...
        return (
            <>
                <Modal
                    ...
                    centered
                >
                    <ModalHeader><h4>Create New Telemedicine</h4></ModalHeader>
                    ...
                    <ModalFooter>
                        <Button onClick={this.handleOnClickCreateNewTelemedicine}>Tạo mới</Button>
